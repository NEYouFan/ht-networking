...
class RestKitTestServer < Sinatra::Base
  ...
  get '/boy' do
      content_type 'application/json'
      render_fixture('/JSON/Dynamic/boy.json', :status => 200)
  end

  get '/girl' do
      content_type 'application/json'
      render_fixture('/JSON/Dynamic/girl.json', :status => 200)
  end

  get '/children' do
      content_type 'application/json'
      render_fixture('/JSON/Dynamic/mixed.json', :status => 200)
  end  

  get '/friends' do
      content_type 'application/json'
      render_fixture('/JSON/Dynamic/friends.json', :status => 200)
  end

  get '/simpleNestedUser' do
      content_type 'application/json'
      render_fixture('/JSON/nested_user.json', :status => 200)
  end      

  get '/parents' do
      content_type 'application/json'
      render_fixture('/JSON/benchmark_parents_and_children.json', :status => 200)
  end
