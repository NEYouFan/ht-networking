                                  ...
                                  onObjectManager:(RKObjectManager *)nilOrObjectManager
{
    ...
    NSURL *URL = [NSURL URLWithString:stubbedPathPattern relativeToURL:objectManager.requestProvider.baseURL];
    NSAssert(URL, @"Failed to build URL from path pattern '%@' relative to base URL '%@'", pathPattern, objectManager.requestProvider.baseURL);
