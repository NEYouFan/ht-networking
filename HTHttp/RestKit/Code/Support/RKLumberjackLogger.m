...
#define  _RKlcl_component(_identifier, _header, _name)                                       \
    ...
    + (DDLogLevel)ddLogLevel {                                                                      \
        ...
        return (DDLogLevel)[RKLumberjackLogger ddLogLevelFromRKLogLevel:level];                          \
    }                                                                                        \
    + (void)ddSetLogLevel:(DDLogLevel)logLevel {                                                    \
        RKLogConfigureByName(_name, [RKLumberjackLogger rkLogLevelFromDDLogLevel:(int)logLevel]); \
    }                                                                                        \
    @end
