...
@implementation HTDemoComplextRequest1
...
//    [mapping addAttributeMappingsFromArray:@[@"name", @"type", @"skuSpecValueList"]];
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:mapping method:RKRequestMethodGET pathPattern:@"/spec" keyPath:@"skuSpecList" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
